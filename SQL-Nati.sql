 ...
 */
 ...
 SELECT P.Detalle as Pregunta , C.Detalle as Categoria, 
		...
		P.IdPregunta IN (SELECT TOP 10 R.Pregunta 
				...
				WHERE R.IdRespuesta = L.Respuesta AND R.esCorrecta = 'N'
				GROUP BY R.Pregunta
...
SELECT P.Detalle as Pregunta , C.Detalle as Categoria, 
		...
		P.IdPregunta IN (SELECT TOP 10 R.Pregunta 
				FROM PARCIAL.Respuestas R, PARCIAL.Logs L
				WHERE R.IdRespuesta = L.Respuesta AND R.esCorrecta = 'S'
				GROUP BY R.Pregunta
